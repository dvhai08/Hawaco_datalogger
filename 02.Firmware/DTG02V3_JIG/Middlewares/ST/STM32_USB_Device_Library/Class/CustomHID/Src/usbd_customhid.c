    ...
    case USB_REQ_TYPE_CLASS :
      switch (req->bRequest)
      {
        ...
        case CUSTOM_HID_REQ_SET_REPORT:
          ...
          USBD_DbgLog("Report buffer sie %u\r\n", req->wLength);
    ...
    case USB_REQ_TYPE_STANDARD:
      switch (req->bRequest)
      {
        case USB_REQ_GET_STATUS:
            USBD_UsrLog("USB_REQ_GET_STATUS\r\n");
        ...
        case USB_REQ_GET_DESCRIPTOR:
            USBD_UsrLog("USB_REQ_GET_DESCRIPTOR\r\n");
                                       ...
                                       uint8_t epnum)
{
  ...
  if (epnum == 1)
  {
        hid_tx_cplt_callback(epnum);
        USBD_LL_PrepareReceive(pdev, CUSTOM_HID_EPOUT_ADDR, pdev->pClassData,
                           USBD_CUSTOMHID_OUTREPORT_BUF_SIZE);

 ...
 */
void app_md5_init(app_md5_ctx *context)
{
...
*/		
void app_md5_update(app_md5_ctx * context, uint8_t *input, uint32_t inputLen)
{
...
*/		
void app_md5_final(uint8_t *digest, app_md5_ctx *context)
{
	uint8_t  bits[8];
	...
	app_md5_update(context, padding, padLen);
	
	// Append length (before padding)
	app_md5_update(context, bits, 8);

 ...
 *----------------------------------------------------------------------------
 *      Name:    EMAC_SAM9G20.H
 *      Purpose: Atmel AT91SAM9260 Ethernet Controller Driver definitions
 *      Rev.:    V4.54
 *----------------------------------------------------------------------------
...
#ifndef __EMAC_SAM9260_H
#define __EMAC_SAM9260_H

#include <AT91SAM9260.H>                      /* AT91SAM9260 definitions     */

/* EMAC Memory Buffer configuration. */
#define NUM_RX_BUF          32          /* 0x1000 for Rx (32*128=4K)         */

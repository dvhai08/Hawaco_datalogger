 ...
 *----------------------------------------------------------------------------
 *      Name:    EMAC_SAM9263.C
 *      Purpose: Driver for Atmel AT91SAM9263 EMAC Ethernet Controller
 *      Rev.:    V4.54
 *----------------------------------------------------------------------------
...
void init_ethernet (void) {
  ...
  pPMC->PMC_PCER  = (1 << AT91C_ID_PIOCDE) | (1 << AT91C_ID_EMAC);
  ...
  pPIOE->PIO_OER   =
  pPIOE->PIO_PER   =
  pPIOE->PIO_CODR  = AT91C_PE25_ERX0 | AT91C_PE26_ERX1 | AT91C_PE27_ERXER;
  ...
  pPIOC->PIO_OER   =
  pPIOC->PIO_PER   =
  pPIOC->PIO_CODR  = AT91C_PC25_ERXDV;
  ...
  pPIOC->PIO_PPUDR =
  pPIOC->PIO_PDR   =
  pPIOC->PIO_BSR   = AT91C_PC25_ERXDV;

  pPIOE->PIO_IDR   =
  pPIOE->PIO_PPUDR =
  pPIOE->PIO_PDR   =
  pPIOE->PIO_ASR   = AT91C_PE21_ETXCK | AT91C_PE23_ETX0  | AT91C_PE24_ETX1  |
                     AT91C_PE25_ERX0  | AT91C_PE26_ERX1  | AT91C_PE27_ERXER |
                     AT91C_PE28_ETXEN | AT91C_PE29_EMDC  | AT91C_PE30_EMDIO;

 ...
 *----------------------------------------------------------------------------
 *      Name:    LPC24_EMAC.H
 *      Purpose: Philips LPC2478 EMAC Ethernet Controller Driver definitions
 *      Rev.:    V4.54
 *----------------------------------------------------------------------------
...
#ifndef __LPC24_EMAC_H
#define __LPC24_EMAC_H
...
#define KSZ8001_DEF_ADR     0x0000      /* Default PHY device address        */

 ...
 *      RL-ARM - TCPnet
 *----------------------------------------------------------------------------
 *      Name:    EMAC_LPC177x_8x.h
 *      Purpose: NXP LPC177x_8x EMAC Ethernet Controller Driver definitions
 *      Rev.:    V4.54
 *----------------------------------------------------------------------------
...
#define EMAC_PIN (1 << 9)               /* EMAC pin multiplexer setting      */
...
#define PHY_REG_PID1        0x02        /* PHY Identifier 1                  */
#define PHY_REG_PID2        0x03        /* PHY Identifier 2                  */
#define PHY_REG_ANAR        0x04        /* Auto-Negotiation Advertisement    */
#define PHY_REG_ANLPAR      0x05        /* Auto-Neg. Link Partner Abitily    */
#define PHY_REG_ANER        0x06        /* Auto-Neg. Expansion Register      */

/* LAN8700 PHY Extended Registers */
#define PHY_REG_SRR         0x10        /* Silicon Revision Register         */
#define PHY_REG_MCSR        0x11        /* Mode Control/Status Register      */
#define PHY_REG_SM          0x12        /* Special Modes Register            */
#define PHY_REG_SECR        0x1A        /* Symbol Error Counter Register     */
#define PHY_REG_CSIR        0x1B        /* Ctrl/Status Indication Register   */
#define PHY_REG_SITC        0x1C        /* Special Internal Testab. Controls */
#define PHY_REG_ISR         0x1D        /* Interrupt Source Register         */
#define PHY_REG_IMR         0x1E        /* Interrupt Mask Register           */
#define PHY_REG_PSCSR       0x1F        /* PHY Special Ctrl/Status Register  */
...
#define LAN8700_ID          0x0007C0C0  /* PHY Identifier                    */

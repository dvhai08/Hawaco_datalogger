 ...
 *----------------------------------------------------------------------------
 *      Name:    LPC32_EMAC.H
 *      Purpose: NXP LPC3250 EMAC Ethernet Controller Driver definitions
 *      Rev.:    V4.54
 *----------------------------------------------------------------------------
...
#ifndef __LPC32_EMAC_H
#define __LPC32_EMAC_H
...
#define LAN8700_DEF_ADR     0x0000      /* Default PHY device address        */
